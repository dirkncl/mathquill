...
export const FocusBlurEvents = (Base) => class extends Base {
    ...
    addEditableFocusBlurEvents() {
        ...
        this.focusHandler = () => {
            ...
            else if (!this.blurredWithCursor && !this.windowBlurred)
                this.selectAll();
            else
                this.cursor.show();
        };
        ...
        this.blurHandler = (e) => {
            ...
            if (this.blurredWithCursor) {
                if (this.cursor.selection)
                    this.cursor.selection.elements.addClass('mq-blur');
                else {
    ...
    unbindEditableFocusBlurEvents() {
        ...
        if (this.windowFocusHandler)
            window.removeEventListener('blur', this.windowFocusHandler);
...
export const BlockFocusBlur = (Base) => class extends Base {
    ...
    blur() {
        ...
        if (this.isEmpty())
            this.elements.addClass('mq-empty');
    }
};
