...
import { Bracket, latexMathParser } from '../src/commands/mathElements.js';
...
suite('latex', function () {
    ...
    suite('\\MathQuillMathField', function () {
        ...
        test('make inner field static and then editable', function () {
            ...
            assert.equal(outer.innerFields.get('m')?.__controller.container.classList.contains('mq-editable-field'), false);
            ...
            assert.equal(outer.innerFields.get('m')?.__controller.container.classList.contains('mq-editable-field'), true);
            assert.equal(outer.innerFields.get('b')?.__controller.editable, true);
