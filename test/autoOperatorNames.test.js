...
import { Letter } from '../src/commands/mathElements.js';
...
suite('autoOperatorNames', function () {
    ...
    test('deleting', function () {
        ...
        mq.typedText('+');
        assertLatex('typed plus to interrupt sequence of letters', 'c+a\\operatorname{cac}a\\operatorname{cac}a\\operatorname{cac}');
